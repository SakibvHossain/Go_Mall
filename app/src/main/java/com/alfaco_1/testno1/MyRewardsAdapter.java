...
class MyRewardsAdapter extends RecyclerView.Adapter<MyRewardsAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull MyRewardsAdapter.Viewholder viewholder, int position) {
        ...
        String date = rewardModelList.get(position).getExpiryData();
            ...
            if(useMiniLayout){
                itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                     ...
                     ProductDetailsActivity.coupenExpireData.setText(date);
