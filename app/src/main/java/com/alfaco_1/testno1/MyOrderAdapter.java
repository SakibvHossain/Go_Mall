...
class MyOrderAdapter extends RecyclerView.Adapter<MyOrderAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull Viewholder viewholder, int position) {
        ...
        int rating = myOrderItemModelList.get(position).getProductImage();
    ...
    public class Viewholder extends RecyclerView.ViewHolder {
        ...
        private void setData(int resource, String title, String deliveredDate,int rating){
            ...
            if(deliveredDate.equals("Cancelled")){
                orderIndicator.setImageTintList(ColorStateList.valueOf(itemView.getContext().getResources().getColor(R.color.red1)));
            }else {
                orderIndicator.setImageTintList(ColorStateList.valueOf(itemView.getContext().getResources().getColor(R.color.recovery)));
            }
